...
"'";
	...
	$conn->close();
?>
<!-- display a form for operator to update statu of patrol car -->
...
'patrolCarId']."'";
	...
	/* else if patrol car status is Arrived (3) then capture the time of completion */ else if ($_POST["patrolCarStatus"] ==
'3'){
